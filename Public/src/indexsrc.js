...
class AppContainer extends HTMLElement {
    constructor() {
        ...
        const menusec = this.ownerDocument.createElement("menu-nav");
        ...
        this.menu = menusec;
        const cardsec = this.ownerDocument.createElement("main-card");
        ...
        dataNewMatches.forEach((newmatch) => {
            const matchcard = this.ownerDocument.createElement("new-matches");
        ...
        dataMusicCard.forEach((music) => {
            const appmusicCard = this.ownerDocument.createElement("music-card");
